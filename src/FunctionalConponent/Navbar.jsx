            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li><button className="dropdown-item" onClick={() => props.changeLanguage('ar')}>Arabic</button></li>
                  <li><button className="dropdown-item" onClick={() => props.changeLanguage('es')}>Spanish</button></li>
                </ul>
              </li>
              <li className="nav-item dropdown">
                <Link className="nav-link dropdown-toggle text-light" to="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li><button className="dropdown-item" onClick={() => props.changePageSize(24)}>24</button></li>
                </ul>
              </li>
            </ul>
            <form className="d-flex" role="search" onSubmit={postData}>
              <input className="form-control me-2" id='search' type="search" name='search' onChange={getData} placeholder="Search" aria-label="Search" />
